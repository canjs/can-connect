...
/*can-connect@1.3.1#helpers/get-items*/
...
/*can-connect@1.3.1#cache-requests/cache-requests*/
...
/*can-connect@1.3.1#helpers/weak-reference-map*/
...
/*can-connect@1.3.1#helpers/overwrite*/
...
/*can-connect@1.3.1#helpers/id-merge*/
...
/*can-connect@1.3.1#constructor/constructor*/
...
/*can-connect@1.3.1#helpers/sorted-set-json*/
...
/*can-connect@1.3.1#constructor/callbacks-once/callbacks-once*/
...
/*can-connect@1.3.1#constructor/store/store*/
...
/*can-connect@1.3.1#data/callbacks/callbacks*/
...
/*can-connect@1.3.1#data/callbacks-cache/callbacks-cache*/
...
/*can-connect@1.3.1#helpers/deferred*/
...
/*can-connect@1.3.1#data/combine-requests/combine-requests*/
...
/*can-connect@1.3.1#helpers/set-add*/
...
/*can-connect@1.3.1#helpers/get-index-by-id*/
...
/*can-connect@1.3.1#data/localstorage-cache/localstorage-cache*/
...
/*can-connect@1.3.1#helpers/clone-data*/
...
/*can-connect@1.3.1#data/memory-cache/memory-cache*/
...
/*can-connect@1.3.1#data/parse/parse*/
...
/*can-connect@1.3.1#helpers/get-id-props*/
...
/*can-connect@1.3.1#data/url/url*/
...
/*can-connect@1.3.1#fall-through-cache/fall-through-cache*/
...
/*can-connect@1.3.1#real-time/real-time*/
...
/*can-connect@1.3.1#can/super-map/super-map*/
...
/*can-connect@1.3.1#can/base-map/base-map*/
