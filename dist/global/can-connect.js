...
/*can-connect@1.5.0-pre.5#connect*/
...
/*can-connect@1.5.0-pre.5#base/base*/
...
/*can-connect@1.5.0-pre.5#can-connect*/
...
/*can-connect@1.5.0-pre.5#helpers/get-items*/
...
/*can-connect@1.5.0-pre.5#helpers/validate*/
...
/*can-connect@1.5.0-pre.5#cache-requests/cache-requests*/
...
/*can-connect@1.5.0-pre.5#helpers/weak-reference-map*/
...
/*can-connect@1.5.0-pre.5#helpers/overwrite*/
...
/*can-connect@1.5.0-pre.5#helpers/id-merge*/
...
/*can-connect@1.5.0-pre.5#constructor/constructor*/
...
/*can-connect@1.5.0-pre.5#helpers/sorted-set-json*/
...
/*can-connect@1.5.0-pre.5#constructor/callbacks-once/callbacks-once*/
...
/*can-connect@1.5.0-pre.5#helpers/weak-reference-set*/
...
/*can-connect@1.5.0-pre.5#constructor/store/store*/
...
/*can-connect@1.5.0-pre.5#data/callbacks/callbacks*/
...
/*can-connect@1.5.0-pre.5#data/callbacks-cache/callbacks-cache*/
...
/*can-connect@1.5.0-pre.5#helpers/deferred*/
...
/*can-connect@1.5.0-pre.5#data/combine-requests/combine-requests*/
...
/*can-connect@1.5.0-pre.5#helpers/set-add*/
...
/*can-connect@1.5.0-pre.5#helpers/get-index-by-id*/
...
/*can-connect@1.5.0-pre.5#data/localstorage-cache/localstorage-cache*/
...
/*can-connect@1.5.0-pre.5#data/memory-cache/memory-cache*/
...
/*can-connect@1.5.0-pre.5#data/parse/parse*/
...
/*can-connect@1.5.0-pre.5#helpers/get-id-props*/
...
/*can-connect@1.5.0-pre.5#data/url/url*/
...
/*can-connect@1.5.0-pre.5#fall-through-cache/fall-through-cache*/
...
/*can-connect@1.5.0-pre.5#real-time/real-time*/
...
/*can-connect@1.5.0-pre.5#can/map/map*/
...
/*can-connect@1.5.0-pre.5#can/ref/ref*/
...
/*can-connect@1.5.0-pre.5#can/super-map/super-map*/
...
/*can-connect@1.5.0-pre.5#can/tag/tag*/
...
/*can-connect@1.5.0-pre.5#can/base-map/base-map*/
