...
/*can-connect@0.5.3#helpers/helpers*/
...
/*can-connect@0.5.3#helpers/get-items*/
...
/*can-connect@0.5.3#cache-requests/cache-requests*/
...
/*can-connect@0.5.3#helpers/weak-reference-map*/
...
/*can-connect@0.5.3#helpers/overwrite*/
...
/*can-connect@0.5.3#helpers/id-merge*/
...
/*can-connect@0.5.3#helpers/wait*/
...
/*can-connect@0.5.3#constructor/constructor*/
...
/*can-connect@0.5.3#helpers/sorted-set-json*/
...
/*can-connect@0.5.3#constructor/callbacks-once/callbacks-once*/
...
/*can-connect@0.5.3#constructor/store/store*/
...
/*can-connect@0.5.3#data/callbacks/callbacks*/
...
/*can-connect@0.5.3#data/callbacks-cache/callbacks-cache*/
...
/*can-connect@0.5.3#data/combine-requests/combine-requests*/
...
/*can-connect@0.5.3#data/inline-cache/inline-cache*/
...
/*can-connect@0.5.3#helpers/set-add*/
...
/*can-connect@0.5.3#data/localstorage-cache/localstorage-cache*/
...
/*can-connect@0.5.3#data/memory-cache/memory-cache*/
...
/*can-connect@0.5.3#data/parse/parse*/
...
/*can-connect@0.5.3#helpers/ajax*/
...
/*can-connect@0.5.3#data/url/url*/
...
/*can-connect@0.5.3#fall-through-cache/fall-through-cache*/
...
/*can-connect@0.5.3#real-time/real-time*/
...
/*can-connect@0.5.3#can/model/model*/
define('can-connect/can/model/model', function (require, exports, module) {
    var $ = require('jquery'), can = require('can/util/util'), connect = require('can-connect'), persist = require('can-connect/data/url/url'), constructor = require('can-connect/constructor/constructor'), instanceStore = require('can-connect/constructor/store/store'), parseData = require('can-connect/data/parse/parse');
    require('can-connect/can/can');
    require('when/es6-shim/Promise');
    var callCanReadingOnIdRead = true;
...
/*can-connect@0.5.3#can/super-map/super-map*/
