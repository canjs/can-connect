...
define(function (require, exports, module) {
    var $ = require('jquery'), can = require('can/util'), connect = require('../../can-connect'), persist = require('../../data/url/url'), constructor = require('../../constructor/constructor'), instanceStore = require('../../constructor/store/store'), parseData = require('../../data/parse/parse');
    require('../can');
