...
var $ = require('jquery'), can = require('can/util/util'), connect = require('../../can-connect.js'), persist = require('../../data/url/url.js'), constructor = require('../../constructor/constructor.js'), instanceStore = require('../../constructor/store/store.js'), parseData = require('../../data/parse/parse.js');
require('../can.js');
