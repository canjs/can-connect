...
var $ = require('jquery'), connect = require('../../can-connect.js'), persist = require('../../data/url/url.js'), constructor = require('../../constructor/constructor.js'), instanceStore = require('../../constructor/store/store.js'), parseData = require('../../data/parse/parse.js'), CanMap = require('can-map'), CanList = require('can-list'), Observation = require('can-observation'), canEvent = require('can-event');
